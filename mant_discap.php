            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-xs-center">
                        <h3 class="mbr-section-title display-2 ">Mantenimiento Discapacidades</h3>
                        <small class="mbr-section-subtitle bg-danger">Editar y Eliminar Registros</small>
                       
                            <br>
                            <?php $r=0; ?>
                            <a href="agregar_discap.php" class="btn btn-info" >Agregar Discapacidad</a>
        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table table-bordered text-lg-center">
                    ...
                    { ?>
                    <tr>                    
                        <td><?php echo $d[$i]['id_disc'] ?></td>
                        <td><?php echo $d[$i]['discapacida'] ?></td>
                        
                        
                        
                        <td><a href="editar_discap.php?id=<?php echo $d[$i]['id_disc'] ?>"  class="btn btn-primary">Editar</a></td>
                        <td><a href="eliminar_discap.php?id=<?php echo $d[$i]['id_disc'] ?>" class="btn btn-danger">Eliminar</a></td>

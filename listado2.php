    ...
    <div class="mbr-testimonials mbr-section mbr-section-nopadding">
        <div class="container">
            <div class="row">
                ...
                <form action="listado2.php" name="buscar" id="buscar" class=" form-group " method="post">
                    ...
                    <tr class="">                    
                        ...
                        echo $edad ; 
                         ...
                         <td><?php echo $user[$i]['telefono_user'] ?></td>                         
                            ...
                            <td><a href="detalle_reg.php?id=<?php echo $user[$i]['id_user'] ?>" class="btn btn-danger">Registrar</a></td> 

...
include 'libreria.php';
     ...
     if (isset($_POST['discap']) and $_POST['discap']!=''){
         $dis=new discap();
         $d=$dis->elimina_discap_id($_POST['ind']);
         ?>
<script>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-xs-center">
                        <h3 class="mbr-section-title display-2 ">Eliminar Discapacida </h3>
                        <small class="mbr-section-subtitle bg-danger">El Modulo de Eliminar Discapacidad </small>
